const ERROR_CODES = {
  ...
  IMAGE_CLEANUP_LEASE_CONFLICT: 'IMAGE_CLEANUP_LEASE_CONFLICT',
  IMAGE_CLEANUP_NOT_DUE: 'IMAGE_CLEANUP_NOT_DUE',
  IMAGE_CLEANUP_STATE_CONFLICT: 'IMAGE_CLEANUP_STATE_CONFLICT',
  IMAGE_CLEANUP_PATH_INVALID: 'IMAGE_CLEANUP_PATH_INVALID',
  IMAGE_CLEANUP_FILE_IN_USE: 'IMAGE_CLEANUP_FILE_IN_USE',
  IMAGE_CLEANUP_DELETE_FAILED: 'IMAGE_CLEANUP_DELETE_FAILED',
  IMAGE_CLEANUP_PARTIAL_FAILED: 'IMAGE_CLEANUP_PARTIAL_FAILED',
  IMAGE_CLEANUP_RETRY_EXHAUSTED: 'IMAGE_CLEANUP_RETRY_EXHAUSTED',
